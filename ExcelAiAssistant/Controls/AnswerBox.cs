...
namespace ExcelAiAssistant.Controls
{
    public partial class AnswerBox : UserControl
    {
        ...
        public AnswerBox(Control parent)
        {
            InitializeComponent();
        ...
        private void OnLanguageChanged()
        {
            ...
            this.lbCaption.Text = Strings.ChatBox_Title;
        }

        private void AnswerBox_Load(object sender, EventArgs e)
        {
            AdjustHeight();
        }
        ...
        private void AdjustHeight()
        {
            if (this.txtAnswer != null)
            {
                using (Graphics g = this.CreateGraphics())
                {
                    ...
                    // 设置 AnswerBox 的高度
                    int h = (int)Math.Ceiling(textSize.Height) + tlpContent.Padding.Top + tlpContent.Padding.Bottom + Padding.Top + Padding.Bottom + barTitle.Height;
                ...
                //// 计算控件的高度
                //int h = lineCount * lineHeight + tlpContent.Padding.Top + tlpContent.Padding.Bottom + Padding.Top + Padding.Bottom + barTitle.Height;
        ...
        private void AnswerBox_SizeChanged(object sender, EventArgs e)
        {
            AdjustHeight();
        }
